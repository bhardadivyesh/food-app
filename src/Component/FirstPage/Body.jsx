...
function Body() {
  ...
  <h1 className="text-center">The best pizza.</h1>
  <h4 className="text-center">Straight out of the oven, straight to you.</h4>
</div>
<div className="flex flex-col items-center">
  <h3  className="text-center">👋 Welcome! Please start by telling us your name:</h3>
  <input
    type="text"
    id="first_name"
    value={name}
