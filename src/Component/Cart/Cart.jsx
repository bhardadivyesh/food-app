...
function Cart() {
  ...
  const totalPrice = value.selectedItem?.reduce(
            ...
            <div className="overflow-y-auto">
              ...
              <div className="border-t border-gray-200 px-6 py-4">
                ...
                <div className="mt-4">
                  <button
                    type="button"
                    className="block w-full py-3 px-6 text-center bg-indigo-600 border border-transparent rounded-md text-base font-medium text-white shadow-sm hover:bg-indigo-700"
                    onClick={handleCheckoutClick}
                    disabled={value.selectedItem.length == 1}
                  >
                    Checkout
                  </button>
                </div>
